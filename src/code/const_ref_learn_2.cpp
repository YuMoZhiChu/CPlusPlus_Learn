...
//
//	int &operator[](int i) {
//		// 函数内部的值可以修改, 这里往往会优先选择引用项
//		cout << "run not const operator[], return int&" << endl;
//		if (i == 0) return x;
//		return y;
//	}
//};
...
//	vector[0] = 1;
//	vector[0] += 1;
//	int test_int = vector[0] + vector[0];
//	const int & a = vector[1];
//	int * test_int_ptr = new int(vector[1]);
//	vector[0] == 1;
//	1 == vector[0];
//
//	int && test_int_right_ref = std::move(vector[1]);
//}
