...
//}
//
//Useless GetUselessTest()
////Useless & GetUselessTest() 改成 引用会报错, 貌似传入的 值直接没了, 感觉可能是生命周期的问题, 返回的内容就是空的
//{
//	Useless a = Useless(3, 'g');
//	return a;
//}
//
//int main()
...
//		//one.ShowData();
//		//Useless three;
//		//three = Useless(3, 'y'); // 因为我们写了移动构造函数, 所以这里是直接移动赋值
//
//		//Useless four(move(three)); // 强制移动构造
//
//		Useless five;
//		five = GetUselessTest();
//	}
